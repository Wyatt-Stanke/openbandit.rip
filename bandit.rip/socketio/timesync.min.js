  ...
  return (function () {
  ...
  })()(
    {
      ...
      4: [
        function (require, module, exports) {
          ...
          function handleResolved(self, deferred) {
            asap(function () {
              var cb =
                self._V === 1 ? deferred.onFulfilled : deferred.onRejected;
              if (cb === null) {
                if (self._V === 1) {
      ...
      14: [
        ...
        { "./request.browser": 13, "./request.node": 15 },
      ],
      15: [
        function (require, module, exports) {
          "use strict";
        ...
        { http: undefined, https: undefined, url: undefined },
      ],
      16: [
        function (require, module, exports) {
          "use strict";
          ...
          function create(options) {
            var timesync = {
              ...
              send: function send(to, data, timeout) {
                return request
                  .post(to, data, timeout)
                  .then(function (val) {
                    var res = val[0];
                    if (val[1] !== 200) {
                      throw new Error(
                        "Send failure: bad HTTP StatusCode (" + val[1] + ")"
                      );
                    }
              ...
              _handleRPCSendError: function _handleRPCSendError(
                id,
                reject,
                err
              ) {
              ...
              rpc: function rpc(to, method, params) {
                ...
                if (
                  sendResult &&
                  (sendResult instanceof Promise ||
                    (sendResult.then && sendResult["catch"]))
                ) {
                  sendResult["catch"](
                    timesync._handleRPCSendError.bind(this, id, reject)
                  );
                } else {
              ...
              _getOffset: function _getOffset(peer) {
                var start = timesync.options.now();
                return timesync
                  .rpc(peer, "timesync")
                  .then(function (timestamp) {
                    var end = timesync.options.now();
                    var roundtrip = end - start;
                    var offset = timestamp - end + roundtrip / 2;
                    if (timesync._isFirst) {
                      timesync._isFirst = false;
                      timesync.offset = offset;
                      timesync.emit("change", offset);
                    }
                    return { roundtrip: roundtrip, offset: offset };
                  })
                  ["catch"](function (err) {
                    return null;
                  });
