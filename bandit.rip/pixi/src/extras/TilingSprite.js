...
export default class TilingSprite extends core.Sprite {
  ...
  _renderCanvas(renderer) {
    ...
    const modX =
      ((this.tilePosition.x / this.tileScale.x) % texture._frame.width) *
      baseTextureResolution;
    const modY =
      ((this.tilePosition.y / this.tileScale.y) % texture._frame.height) *
      baseTextureResolution;
    ...
    if (!this._canvasPattern) {
      ...
      const tempCanvas = new core.CanvasRenderTarget(
